...
int obfs_tls_request(buffer_t *, size_t, obfs_t *, obfs_para_t *);
int deobfs_tls_response(buffer_t *, size_t, obfs_t *);
int obfs_app_data(buffer_t *, size_t, obfs_t *);
int deobfs_app_data(buffer_t *, size_t, obfs_t *);
